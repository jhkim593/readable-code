...
public class StudyCafePassMachine {
    ...
    public void run() {
        try {
            ...
            StudyCafePassOrder passOrder = StudyCafePassOrder.create(selectedPass, optionalLockerPass.orElse(null));
    ...
    private Optional<StudyCafeLockerPass> selectLockerPass(StudyCafeSeatPass selectedPass) {
        ...
        if (lockerPassCandidate.isPresent()) {
            ...
            if(isLockerSelected) return Optional.of(lockerPass);
        }
        return Optional.empty();
    }

    private Optional<StudyCafeLockerPass> findLockerPassCandidateBy(StudyCafeSeatPass pass) {
        StudyCafeLockerPasses lockerPasses = lockerPassProvider.getSeatLockerPasses();
        return lockerPasses.findPassBy(pass);
    }
